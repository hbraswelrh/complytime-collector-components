...
// ---------------------------------
// OTel Collector packages are pinned to v1.61.0 (stable) and v0.155.0 (experimental) to match
// the requirements of opentelemetry-collector-contrib v0.155.0 (used in beacon-distro/manifest.yaml).
//
